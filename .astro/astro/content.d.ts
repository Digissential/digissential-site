...
"laptop-battery-replacement.md": {
	id: "laptop-battery-replacement.md";
...
"remote-session-hourly.md": {
	id: "remote-session-hourly.md";
  slug: "remote-session-hourly";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
...
"ssd-upgrade-migration.md": {
	id: "ssd-upgrade-migration.md";
...
"thermal-service.md": {
	id: "thermal-service.md";
  slug: "thermal-service";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
